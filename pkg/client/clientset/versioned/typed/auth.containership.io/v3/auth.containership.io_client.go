...
func NewForConfig(c *rest.Config) (*ContainershipAuthV3Client, error) {
	...
	return &ContainershipAuthV3Client{client}, nil
}

// NewForConfigOrDie creates a new ContainershipAuthV3Client for the given config and
...
func New(c rest.Interface) *ContainershipAuthV3Client {
	return &ContainershipAuthV3Client{c}
}
