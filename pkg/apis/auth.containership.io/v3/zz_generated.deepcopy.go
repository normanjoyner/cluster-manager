...
func (in *AuthorizationRoleBinding) DeepCopy() *AuthorizationRoleBinding {
	if in == nil {
		return nil
	}
	out := new(AuthorizationRoleBinding)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AuthorizationRoleBindingList) DeepCopy() *AuthorizationRoleBindingList {
	if in == nil {
		return nil
	}
	out := new(AuthorizationRoleBindingList)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AuthorizationRoleBindingSpec) DeepCopyInto(out *AuthorizationRoleBindingSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthorizationRoleBindingSpec.
func (in *AuthorizationRoleBindingSpec) DeepCopy() *AuthorizationRoleBindingSpec {
	if in == nil {
		return nil
	}
	out := new(AuthorizationRoleBindingSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AuthorizationRoleList) DeepCopy() *AuthorizationRoleList {
	if in == nil {
		return nil
	}
	out := new(AuthorizationRoleList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AuthorizationRoleSpec) DeepCopyInto(out *AuthorizationRoleSpec) {
	*out = *in
	if in.Rules != nil {
		...
		*out = make([]AuthorizationRuleSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AuthorizationRoleSpec) DeepCopy() *AuthorizationRoleSpec {
	if in == nil {
		return nil
	}
	out := new(AuthorizationRoleSpec)
	in.DeepCopyInto(out)
	return out
}
